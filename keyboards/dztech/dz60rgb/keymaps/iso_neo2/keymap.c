...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
           ...
           _______,   ALGR(KC_MINS),    S(KC_7), ALGR(KC_7),    ALGR(KC_0),    S(KC_RBRC), S(KC_MINS),    S(KC_8),    S(KC_9),    KC_SLSH,  S(KC_DOT),        ALGR(KC_Q),                    KC_ENT,
           _______,                     KC_NUHS,     KC_DLR, ALGR(KC_NUBS), ALGR(KC_RBRC),   UC(0x60),    KC_RBRC,    S(KC_5),    S(KC_2), S(KC_NUHS),        S(KC_COMM),  _______,          KC_DEL,
    ...
    [3] = LAYOUT(
         UC(0x307),      UC(0x1D43), UC(0x1D52), C(0x2116),    UC(0x22EE),     UC(0x183),   UC(0xA3),   UC(0xA4),     KC_TAB,    KC_PSLS,    KC_PAST,           KC_PMNS, UC(0x308),        KC_BSPC,
           _______,         KC_PGUP,    KC_BSPC,      KC_UP,        KC_DEL,       KC_PGDN,   UC(0xD7),      KC_P7,      KC_P8,      KC_P9,    KC_PPLS,        UC(0x2212), UC(0x30B),       _______,
           _______,         KC_HOME,    KC_LEFT,    KC_DOWN,       KC_RGHT,        KC_END,   UC(0xF7),      KC_P4,      KC_P5,      KC_P6,    KC_COMM,           KC_DOT,                   KC_PENT,
           KC_LSFT,                      KC_ESC,     KC_TAB,        KC_INS,        KC_ENT,    C(KC_Z),  S(KC_DOT),      KC_P1,      KC_P2,      KC_P3, SFT_T(S(KC_COMM)),   _______,        KC_DEL,
           _______,         _______,    KC_LALT,                             KC_P0,                                               KC_RALT,    _______,           _______,   _______,       _______
    ),
    [4] = LAYOUT(
         UC(0x309),      UC(0x2081), UC(0x2082), UC(0x2083),    UC(0x2642),    UC(0x2640), UC(0x26A5),  UC(0x3F0), UC(0x27E8), UC(0x27E9), UC(0x2080),        UC(0x2011), UC(0x314),       KC_BSPC,
            KC_TAB,       UC(0x3BE),    XXXXXXX,  UC(0x3BB),     UC(0x3C7),     UC(0x3C9),  UC(0x3BA),  UC(0x3C8),  UC(0x3B3),  UC(0x278),  UC(0x3C6),         UC(0x3C2), UC(0x313),       _______,
           _______,         XXXXXXX,  UC(0x3B9),  UC(0x3B1),     UC(0x3B5),     UC(0x3BF),  UC(0x3C3),  UC(0x3BD),  UC(0x3C1),  UC(0x3C4),  UC(0x3B4),         UC(0x3C5),                   KC_ENT,
           _______,                    UC(0xB5),  UC(0x3F5),     UC(0x3B7),     UC(0x3C0),  UC(0x3B6),  UC(0x3B2),  UC(0x3BC),  UC(0x3F1),  UC(0x3D1),         UC(0x3B8),   _______,        KC_DEL,
           _______,         _______,    KC_LALT,                            UC(0xA0),                                             KC_RALT,    _______,           _______,   _______,       _______
    ),
    [5] = LAYOUT(
         UC(0x323),        UC(0xAC), UC(0x2228), UC(0x2227),    UC(0x22A5),    UC(0x2221), UC(0x2225), UC(0x2192), UC(0x221E), UC(0x221D), UC(0x2205),          UC(0xAD), UC(0x304),       KC_BSPC,
            KC_TAB,       UC(0x39E), UC(0x221A),  UC(0x39B),    UC(0x2102),     UC(0x3A9),   UC(0xD7),  UC(0x3A8),  UC(0x393),  UC(0x3A6), UC(0x211A),        UC(0x2218), UC(0x306),       _______,
           _______,      UC(0x2282), UC(0x222B), UC(0x2200),    UC(0x2203),    UC(0x2208),  UC(0x3A3), UC(0x2115), UC(0x211D), UC(0x2202), UC(0x2206),        UC(0x2207),                   KC_ENT,
           KC_LSFT,                  UC(0x22C3), UC(0x22C2),    UC(0x2135),     UC(0x3A0), UC(0x2124), UC(0x21D5), UC(0x21D4), UC(0x21D2), UC(0x21A6),         UC(0x398),   _______,        KC_DEL,
           _______,         _______,    KC_LALT,                        UC(0x202F),                                               KC_RALT,    _______,           _______,   _______,       _______
    ),
    [6] = LAYOUT(
           KC_GESC,            KC_1,       KC_2,       KC_3,          KC_4,       KC_5,          KC_6,       KC_7,       KC_8,       KC_9,       KC_0,           KC_MINS,    KC_EQL,       KC_BSPC,
            KC_TAB,            KC_Q,       KC_W,       KC_E,          KC_R,       KC_T,          KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,           KC_LBRC,   KC_RBRC,       KC_BSLS,
    CTL_T(KC_CAPS),            KC_A,       KC_S,       KC_D,          KC_F,       KC_G,          KC_H,       KC_J,       KC_K,       KC_L,    KC_SCLN,           KC_QUOT,                   KC_ENT,
           KC_LSFT,                        KC_Z,       KC_X,          KC_C,       KC_V,          KC_B,       KC_N,       KC_M,    KC_COMM,     KC_DOT,   RSFT_T(KC_SLSH),     KC_UP,  LT(7,KC_DEL),
